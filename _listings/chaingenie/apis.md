...
created: "2018-08-27"
modified: "2018-08-27"
url: https://raw.githubusercontent.com/streamdata-gallery-topics/generates/master/_listings/chaingenie/apis.md
...
- name: ChainGenie = DLT + Blockchain + Magic - Generate and Manage Document (Basic)
  ...
  - type: x-postman-collection
    url: https://raw.githubusercontent.com/streamdata-gallery-topics/generates/master/_listings/chaingenie/ethledgerdocert-post-postman.md
  - type: x-openapi-spec
    url: https://raw.githubusercontent.com/streamdata-gallery-topics/generates/master/_listings/chaingenie/ethledgerdocert-post-openapi.md
- name: ChainGenie = DLT + Blockchain + Magic - Generate, Sign & Route Document (Advanced)
  ...
  properties:
  - type: x-postman-collection
    url: https://raw.githubusercontent.com/streamdata-gallery-topics/generates/master/_listings/chaingenie/ethledgerinvokecontract-post-postman.md
  - type: x-openapi-spec
    url: https://raw.githubusercontent.com/streamdata-gallery-topics/generates/master/_listings/chaingenie/ethledgerinvokecontract-post-openapi.md
x-common:
- type: x-github
