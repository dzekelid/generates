...
created: "2018-08-25"
modified: "2018-08-25"
url: https://raw.githubusercontent.com/streamdata-gallery-topics/generates/master/_listings/aws-simple-email-service/apis.md
...
- name: AWS Simple Email Service API - Send Bounce
  ...
  - type: x-postman-collection
    url: https://raw.githubusercontent.com/streamdata-gallery-topics/generates/master/_listings/aws-simple-email-service/actionsendbounce-get-postman.md
  - type: x-openapi-spec
    url: https://raw.githubusercontent.com/streamdata-gallery-topics/generates/master/_listings/aws-simple-email-service/actionsendbounce-get-openapi.md
- name: AWS Simple Email Service API - Send Bounce
  x-api-slug: actionsendbounce-get
  description: Generates and sends a bounce message to the sender of an email you
    received through Amazon SES.
